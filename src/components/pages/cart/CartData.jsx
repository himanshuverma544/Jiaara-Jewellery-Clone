    ...
    <UsersProductsList 
      ...
      productQuantityComponent={
        <ProductQuantity
          ...
          inputClassName="w-[1.5rem] px-2 py-1 rounded-sm outline-none text-center text-xs input-selection-primaryFont focus:ring-1 hover:ring-1 focus:ring-primaryFont hover:ring-secondaryBackground xs:w-[2rem] xs:text-base sm:px-3 sm:py-2"
