...
import isEven from "@/utils/functions/isEven";
...
const collections = [
  {
    id: 1,
    label: '18K Gold',
    image: '/assets/pages/homepage/sections/7-Collection/2.jpg'
  },
  { 
    id: 2,
    label: 'Brass',
    image: '/assets/pages/homepage/sections/7-Collection/1.jpg'
  },
  {
    id: 3,
    label: 'For Him',
    image: '/assets/pages/homepage/sections/7-Collection/4.webp'
  },
  { 
    id: 4,
    label: 'Ethnic',
    image: '/assets/pages/homepage/sections/7-Collection/3.jpg'
  },
  {
    id: 5,
    label: 'Minimalist',
    image: '/assets/pages/homepage/sections/7-Collection/5.jpg'
  }
];

// TODO: Make the below calculation general for any number of collections
const collectionsNum = 5;
const counter = Math.ceil(collections.length / collectionsNum);
const rowsLength = collections.length - (counter * 2);
          ...
          <React.Fragment key={index}>
            ...
            {screenWidth < md &&
              <div className={`row-${rowNum++} collection-${pos + 1} relative`}>
                ...
                <div className="absolute left-0 bottom-0 w-full flex flex-wrap flex-col items-start justify-center gap-1 px-3 py-3 text-xs font-semibold overlay-black-50 after:rounded-b-xl text-white sm:flex-row sm:justify-between sm:items-center sm:text-sm md:text-base">
                  <div className="label ms-0.5 z-10 uppercase">
                    {collections[pos++]?.label}
                  </div>
            ...
            <div className={`row-${rowNum++} grid grid-cols-12 gap-2 md:grid-cols-11`}>
              ...
              <div className={`
                ...
                relative
                md:col-span-3
                ${isEven(index) ? "md:order-first" : "md:order-last"}
              `}>
                <div className={`
                  img-cont
                  relative
